...
Voix 1 et 2 : On y va""",
        "transcript_segments": [
            {"start": 0,  "end": 4,  "speaker": "Voix 1", "text": "Salut toi et bienvenue dans la Mirokaï Experience. Aujourd'hui, on démarre une visite vraiment spéciale."},
            {"start": 4,  "end": 11, "speaker": "Voix 2", "text": "Oui, parce qu'on va te parler des robots Mirokaï, créés par Enchanted Tools. Et crois-moi, ces robots-là ne ressemblent à aucun autre."},
            {"start": 11, "end": 14, "speaker": "Voix 1", "text": "Ah oui ? Qu'est-ce qu'ils ont de si particulier ?"},
            {"start": 14, "end": 30, "speaker": "Voix 2", "text": "Tout a commencé avec Jérôme Monceaux, le fondateur d'Enchanted Tools. En développant des robots, il s'est rendu compte que plus ils avaient des traits d'êtres vivants, plus il était facile pour nous de ressentir des émotions à leur égard. Alors, avec son équipe, il est allé encore plus loin. Ils ont imaginé tout un peuple, les Mirokaï, originaires d'une autre planète."},
            {"start": 30, "end": 37, "speaker": "Voix 1", "text": "Ah d'accord ! Alors c'est comme ça que Miroki et Miroka sont apparus ? Deux personnages qui ont ensuite été transformés en vrais robots grâce aux ingénieurs."},
            {"start": 37, "end": 43, "speaker": "Voix 2", "text": "Exactement ! Et maintenant, c'est à toi, jeune explorateur, de découvrir leur monde magique. Prêt pour l'aventure ?"},
        ],
    },
    {
        "number": 2,
...
Voix 1 : Et là, les Mirokaï quittent le papier et les écrans pour devenir de vrais robots qu'on peut voir et toucher. C'est comme ça que des personnages imaginaires sont devenus de vrais robots prêts à vivre leurs aventures sur Terre.""",
        "transcript_segments": [
            {"start": 0,  "end": 10, "speaker": "Voix 1", "text": "Hé ! Tu t'es déjà demandé comment les Mirokaï ont été inventés ? Au tout début, il n'y avait presque rien. On savait juste qu'ils allaient rouler sur une boule, et c'est tout."},
            {"start": 10, "end": 14, "speaker": "Voix 2", "text": "Attends, quoi ? Pas de tête, pas de couleurs, pas de formes ?"},
            {"start": 14, "end": 19, "speaker": "Voix 1", "text": "Rien du tout. Alors une illustratrice est arrivée pour leur donner une apparence dans leur monde imaginaire."},
            {"start": 19, "end": 23, "speaker": "Voix 2", "text": "Ah oui ! C'est elle qui dessinait leurs yeux, leurs cheveux, leur taille."},
            {"start": 23, "end": 32, "speaker": "Voix 1", "text": "Exactement ! Grâce à elle, on savait enfin à quoi allaient ressembler Miroki et Miroka, mais seulement en dessin. Et pour les transformer en version robotique, il fallait quelqu'un d'autre."},
            {"start": 32, "end": 43, "speaker": "Voix 2", "text": "Le designer ! Lui, il a imaginé leur apparence robotique : les formes, les coques, comment leur corps allait tenir sur la boule. Mais attention, il ne construit pas encore le robot, il imagine juste à quoi il va ressembler dans la vraie vie."},
            {"start": 43, "end": 46, "speaker": "Voix 1", "text": "Et ensuite, c'est le modeleur 3D qui a pris le relais."},
            {"start": 46, "end": 49, "speaker": "Voix 2", "text": "Celui qui sculpte tout sur l'ordinateur, c'est ça ?"},
            {"start": 49, "end": 55, "speaker": "Voix 1", "text": "Oui ! Il transforme les dessins en volume. Il ajoute les détails et vérifie que tout s'équilibre."},
            {"start": 55, "end": 60, "speaker": "Voix 2", "text": "Je l'imagine très bien... \"Oups ! La tête est un peu trop grosse ! Ah, là c'est mieux.\""},
            {"start": 60, "end": 63, "speaker": "Voix 1", "text": "Exactement ! Et une fois que le designer et le modeleur sont d'accord..."},
            {"start": 63, "end": 67, "speaker": "Voix 2", "text": "On peut enfin imprimer les pièces ! Puis les assembler, les tester."},
            {"start": 67, "end": 77, "speaker": "Voix 1", "text": "Et là, les Mirokaï quittent le papier et les écrans pour devenir de vrais robots qu'on peut voir et toucher. C'est comme ça que des personnages imaginaires sont devenus de vrais robots prêts à vivre leurs aventures sur Terre."},
        ],
    },
    {
        "number": 4,
...
Voix 2 : Ah, les enchanteurs ont vraiment bien travaillé décidément ! Il en a de la chance ce Mirokaï d'avoir une aussi belle combinaison.""",
        "transcript_segments": [
            {"start": 0,  "end": 9,  "speaker": "Voix 1", "text": "Tu vois cette combinaison ? C'est la toute première des Mirokaï. À l'époque, elle n'avait pas encore toutes les options d'aujourd'hui. Par exemple, pas d'anneau de sécurité autour de la base."},
            {"start": 9,  "end": 15, "speaker": "Voix 2", "text": "Il y a eu beaucoup d'évolutions depuis cette première version. Mais celle-là reste fascinante. Regarde la boule sur laquelle il tient en équilibre."},
            {"start": 15, "end": 24, "speaker": "Voix 1", "text": "Oui, et ce sont ces trois petites roues sur les côtés qui font bouger la boule. Grâce à elles, le robot peut aller dans toutes les directions : en avant, en arrière, sur le côté, ou même tourner sur place."},
            {"start": 24, "end": 32, "speaker": "Voix 2", "text": "Et si tu le touches, pas de panique ! Il s'adapte aux mouvements humains. Par exemple, s'il rencontre un obstacle, il s'arrête automatiquement pour ne rien abîmer."},
            {"start": 32, "end": 35, "speaker": "Voix 1", "text": "Et pour voir autour de lui, il a une caméra devant."},
            {"start": 35, "end": 41, "speaker": "Voix 2", "text": "Et plein de petits capteurs tout autour, comme des lasers et des ultrasons. Grâce à eux, il détecte même les vitres."},
            {"start": 41, "end": 43, "speaker": "Voix 1", "text": "Waouh ! Comme des super-pouvoirs !"},
            {"start": 43, "end": 51, "speaker": "Voix 2", "text": "Et oui ! Et sa batterie est beaucoup plus performante que sur le premier modèle. Et sur les nouvelles versions, le Mirokaï peut même retourner tout seul à sa station pour se recharger."},
            {"start": 51, "end": 58, "speaker": "Voix 1", "text": "Regarde ses bras, ils bougent comme les tiens ! Et ses mains à quatre doigts lui permettent d'attraper des objets conçus spécialement pour lui."},
            {"start": 58, "end": 63, "speaker": "Voix 2", "text": "Sa tête, quant à elle, peut te suivre du regard ou se tourner quand elle entend un son."},
            {"start": 63, "end": 69, "speaker": "Voix 1", "text": "Et ses petites oreilles toutes souples, elles te montrent ses émotions. C'est discret, mais ça le rend tellement attachant."},
            {"start": 69, "end": 74, "speaker": "Voix 2", "text": "Ah, les enchanteurs ont vraiment bien travaillé décidément ! Il en a de la chance ce Mirokaï d'avoir une aussi belle combinaison."},
        ],
    },
    {
        "number": 5,
...
Voix 1 : C'est un peu cet effet-là que ça fait, les Mirokaï, tu sais.""",
        "transcript_segments": [
            {"start": 0,  "end": 8,  "speaker": "Voix 1", "text": "On a vu que le robot tenait en équilibre sur une boule. Mais tu sais comment il fait ça ? C'est grâce à un principe de physique étonnant : le pendule inversé."},
            {"start": 8,  "end": 11, "speaker": "Voix 2", "text": "Le pendule inversé ? Mais c'est quoi ça ?"},
            {"start": 11, "end": 19, "speaker": "Voix 1", "text": "Eh bien, un pendule normal, comme un balancier d'horloge, oscille toujours autour de sa position basse. La gravité le ramène vers le bas et il se remet donc toujours à sa place."},
            {"start": 19, "end": 22, "speaker": "Voix 2", "text": "Ah je vois ! Comme un balancier qui va et vient."},
            {"start": 22, "end": 29, "speaker": "Voix 1", "text": "Exact. Mais dans un pendule inversé, c'est le contraire. La gravité pousse l'objet à tomber. Il devient instable, et pour qu'il reste debout, il faut corriger sa position tout le temps."},
            {"start": 29, "end": 35, "speaker": "Voix 2", "text": "Oh ! Comme quand tu essaies de tenir une sucette sur le bout de ton doigt. Tu dois corriger ta position sans arrêt pour qu'elle ne tombe pas."},
            {"start": 35, "end": 46, "speaker": "Voix 1", "text": "Exactement ! Et si tu essaies, tu verras que plus la sucette est grosse et lourde en haut, plus il est facile de la stabiliser. C'est le même principe pour les Mirokaï. Leurs composants les plus lourds, comme la batterie, sont placés en haut de la combinaison pour les aider à rester stables."},
            {"start": 46, "end": 53, "speaker": "Voix 2", "text": "Et le robot ajuste sa position tout le temps, vraiment très vite, pour ne jamais perdre l'équilibre. Même si la boule roule ou s'arrête brusquement, il corrige ses mouvements en continu."},
            {"start": 53, "end": 59, "speaker": "Voix 1", "text": "Grâce à ça, le Mirokaï peut se déplacer partout, observer autour de lui et interagir avec les humains, tout en restant parfaitement stable."},
            {"start": 59, "end": 62, "speaker": "Voix 2", "text": "Waouh ! C'est presque magique, non ?"},
            {"start": 62, "end": 65, "speaker": "Voix 1", "text": "C'est un peu cet effet-là que ça fait, les Mirokaï, tu sais."},
        ],
    },
    {
        "number": 6,
...
Voix 1 : Mais oui ! Ce sont de vrais compagnons qui rendent la vie plus douce et aident là où ils se sentent vraiment utiles.""",
        "transcript_segments": [
            {"start": 0,  "end": 6,  "speaker": "Voix 1", "text": "Quand on parle de robots, on pense souvent à des machines sans émotions. Mais les Mirokaï, c'est tout le contraire."},
            {"start": 6,  "end": 12, "speaker": "Voix 2", "text": "Oui, ces robots-là sont faits pour apporter de la présence, de l'attention et du soutien aux humains."},
            {"start": 12, "end": 18, "speaker": "Voix 1", "text": "On peut les retrouver un peu partout où il y a du public : hôtels, restaurants, aéroports…"},
            {"start": 18, "end": 24, "speaker": "Voix 2", "text": "Mais tu sais quoi ? Ils adorent le milieu hospitalier et les maisons de retraite. Là-bas, ils se sentent vraiment utiles."},
            {"start": 24, "end": 34, "speaker": "Voix 1", "text": "Exact ! Avec leur voix toute douce, leur visage expressif et leurs mouvements naturels, ils rassurent, écoutent et accompagnent ceux qui en ont le plus besoin."},
            {"start": 34, "end": 43, "speaker": "Voix 2", "text": "Dans les maisons de retraite par exemple, ils peuvent rappeler de boire de l'eau, annoncer des activités du jour ou demander comment s'est passé le repas."},
            {"start": 43, "end": 49, "speaker": "Voix 1", "text": "Et ça, ça permet de laisser plus de temps aux soignants pour s'occuper de ce qui demande vraiment de l'attention."},
            {"start": 49, "end": 60, "speaker": "Voix 2", "text": "Ils peuvent aussi faire des tournées de nuit, vérifier que personne ne risque de tomber et même animer des moments calmes : lire les actualités, lancer un quiz musical ou proposer un atelier de mémoire."},
            {"start": 60, "end": 68, "speaker": "Voix 1", "text": "Ce qui est important, c'est qu'ils ne remplacent pas les humains. Ils apportent un soutien, un sourire et un accompagnement quand c'est nécessaire."},
            {"start": 68, "end": 72, "speaker": "Voix 2", "text": "Finalement, les Mirokaï ne sont pas des robots froids de science-fiction !"},
            {"start": 72, "end": 78, "speaker": "Voix 1", "text": "Mais oui ! Ce sont de vrais compagnons qui rendent la vie plus douce et aident là où ils se sentent vraiment utiles."},
        ],
    },
    {
        "number": 7,
...
Voix 2 : Oui ! Grâce à leur vision magique, ils explorent le monde comme jamais.""",
        "transcript_segments": [
            {"start": 0,  "end": 6,  "speaker": "Voix 1", "text": "Dis-moi, comment les Mirokaï arrivent à voir et à comprendre tout ce qui se passe autour d'eux ?"},
            {"start": 6,  "end": 11, "speaker": "Voix 2", "text": "Ah ça, c'est leur super-pouvoir ! Ils regardent les visages comme de vrais détectives."},
            {"start": 11, "end": 12, "speaker": "Voix 1", "text": "Des détectives ?"},
            {"start": 12, "end": 18, "speaker": "Voix 2", "text": "Oui ! Ils observent les sourcils, les yeux et la bouche pour deviner si quelqu'un est content, triste ou surpris."},
            {"start": 18, "end": 21, "speaker": "Voix 1", "text": "Ah, donc ils peuvent reconnaître les émotions !"},
            {"start": 21, "end": 26, "speaker": "Voix 2", "text": "Exactement. Et ce n'est pas tout ! Ils savent aussi qui parle dans la pièce en regardant les mouvements des lèvres."},
            {"start": 26, "end": 33, "speaker": "Voix 1", "text": "Trop fort ! Et ils voient aussi les objets ?"},
            {"start": 33, "end": 48, "speaker": "Voix 2", "text": "Bien sûr, ils les reconnaissent tous ! Mais ils peuvent seulement attraper les accessoires avec des poignées conçues spécialement pour eux, comme un plateau, un panier ou même une fleur qui fait des bulles de savon. Ça leur permet de ne pas attraper tout et n'importe quoi."},
            {"start": 48, "end": 57, "speaker": "Voix 1", "text": "C'est pratique ça, les poignées ! Comme ça on peut les accrocher à autant d'accessoires qu'on veut. Les possibilités sont vraiment infinies. Mais au juste, comment ils savent où elles se trouvent ?"},
            {"start": 57, "end": 66, "speaker": "Voix 2", "text": "Ils ont une caméra spéciale sur la tête, un peu comme des lunettes magiques qui mesurent les distances. Grâce à elle, ils savent exactement où sont les gens et les objets."},
            {"start": 66, "end": 69, "speaker": "Voix 1", "text": "Waouh ! Et ils ont appris où tout ça ?"},
            {"start": 69, "end": 75, "speaker": "Voix 2", "text": "Comme toi, quand tu apprends à reconnaître les animaux. Ils ont vu des milliers d'images de visages et d'objets."},
            {"start": 75, "end": 78, "speaker": "Voix 1", "text": "Les Mirokaï sont vraiment des robots incroyables."},
            {"start": 78, "end": 82, "speaker": "Voix 2", "text": "Oui ! Grâce à leur vision magique, ils explorent le monde comme jamais."},
        ],
    },
    {
        "number": 8,
...
Voix 2 : Eh bien, quand on l'utilise correctement, c'est un outil super utile ! Ça aide à reconnaître, à guider, à discuter... Mais ça reste un outil, pas un cerveau magique. L'IA peut en faire des choses, mais c'est grâce aux humains qu'elle devient vraiment utile.""",
        "transcript_segments": [
            {"start": 0,  "end": 8,  "speaker": "Voix 1", "text": "Aujourd'hui, on va parler d'un mot qu'on entend un peu partout : l'Intelligence Artificielle, qu'on appelle souvent l'IA. Mais au fond, qu'est-ce que c'est ?"},
            {"start": 8,  "end": 13, "speaker": "Voix 2", "text": "Très bonne question ! L'IA, c'est un programme qui aide un robot ou une machine à deviner ce qu'il doit faire."},
            {"start": 13, "end": 18, "speaker": "Voix 1", "text": "Deviner ? Comme dans les jeux où on doit trouver la bonne réponse ?"},
            {"start": 18, "end": 24, "speaker": "Voix 2", "text": "Oui, c'est à peu près ça. On lui montre des milliers d'exemples et il finit par reconnaître les choses tout seul."},
            {"start": 24, "end": 31, "speaker": "Voix 1", "text": "Donc, si un Mirokaï répond à ma question ou trouve son chemin, c'est l'IA qui lui dit quoi faire ?"},
            {"start": 31, "end": 39, "speaker": "Voix 2", "text": "Oui, mais attention ! Il ne comprend pas vraiment. Il choisit juste la réponse qui lui paraît la plus logique."},
            {"start": 39, "end": 41, "speaker": "Voix 1", "text": "Hmm, donc ils peuvent se tromper ?"},
            {"start": 41, "end": 49, "speaker": "Voix 2", "text": "Oui, ça peut arriver parce que l'IA, ce n'est pas une science exacte. Elle devine à partir de ce qu'elle a appris, donc parfois, la réponse n'est pas parfaite."},
            {"start": 49, "end": 51, "speaker": "Voix 1", "text": "Mais alors, à quoi ça sert ?"},
            {"start": 51, "end": 64, "speaker": "Voix 2", "text": "Eh bien, quand on l'utilise correctement, c'est un outil super utile ! Ça aide à reconnaître, à guider, à discuter... Mais ça reste un outil, pas un cerveau magique. L'IA peut en faire des choses, mais c'est grâce aux humains qu'elle devient vraiment utile."},
        ],
    },
    {
        "number": 9,
...
Voix 2 : Et ça permet de s'assurer que les robots bougent, voient et réagissent correctement avant de les construire vraiment.""",
        "transcript_segments": [
            {"start": 0,  "end": 6,  "speaker": "Voix 1", "text": "Tu vois cette planche ? C'est une maquette électronique sur table. Les enchanteurs s'en servent pour fabriquer les Mirokaï."},
            {"start": 6,  "end": 9,  "speaker": "Voix 2", "text": "Une maquette électronique... Ça sert à quoi exactement ?"},
            {"start": 9,  "end": 21, "speaker": "Voix 1", "text": "Eh bien, avant de construire le robot en entier, avec tous ses bras, sa tête, ses moteurs et ses capteurs, on teste d'abord les éléments essentiels ici. Par exemple, faire bouger un moteur, allumer une lumière ou vérifier qu'un capteur détecte bien quelque chose."},
            {"start": 21, "end": 26, "speaker": "Voix 2", "text": "Ah ! Donc ils peuvent voir si tout fonctionne correctement avant de tout assembler."},
            {"start": 26, "end": 34, "speaker": "Voix 1", "text": "Oui, c'est un peu le principe. C'est beaucoup plus simple que de réparer ou de changer quelque chose directement sur le robot. Et ça aide les enchanteurs à comprendre comment chaque pièce communique avec les autres."},
            {"start": 34, "end": 38, "speaker": "Voix 2", "text": "Comme ça, quand ils construisent le vrai robot, tout fonctionne parfaitement."},
            {"start": 38, "end": 44, "speaker": "Voix 1", "text": "C'est ça. La maquette sur table, c'est un peu comme un laboratoire miniature pour préparer les Mirokaï."},
            {"start": 44, "end": 50, "speaker": "Voix 2", "text": "Et ça permet de s'assurer que les robots bougent, voient et réagissent correctement avant de les construire vraiment."},
        ],
    },
    {
        "number": 10,
...
Voix 1 : Exact. Cette fois, c'est la bonne : le Mirokaï est enfin prêt !""",
        "transcript_segments": [
            {"start": 0,   "end": 6,   "speaker": "Voix 1", "text": "Dans ce bâtiment se trouve une mini-usine qu'on appelle la ligne pilote de production."},
            {"start": 6,   "end": 10,  "speaker": "Voix 2", "text": "Une mini-usine ? Mais elle sert à quoi exactement ?"},
            {"start": 10,  "end": 23,  "speaker": "Voix 1", "text": "Elle sert à tester nos robots, étape par étape, pour être sûrs qu'ils fonctionnent bien avant de fabriquer tous les exemplaires. Ce que tu vois, c'est une des salles où l'on teste les Mirokaï. La plus grande se situe au troisième étage de notre bâtiment."},
            {"start": 23,  "end": 26,  "speaker": "Voix 2", "text": "Et on commence par où pour ces tests ?"},
            {"start": 26,  "end": 30,  "speaker": "Voix 1", "text": "Par l'électronique. On vérifie que les petites cartes et les moteurs marchent correctement."},
            {"start": 30,  "end": 33,  "speaker": "Voix 2", "text": "Et après, on assemble le robot ?"},
            {"start": 33,  "end": 43,  "speaker": "Voix 1", "text": "Oui : les bras, les mains, la tête, le buste et le rolling globe, tu sais, la boule sur laquelle le robot se déplace."},
            {"start": 43,  "end": 48,  "speaker": "Voix 2", "text": "Waouh ! Et il y en a beaucoup des pièces à assembler ?"},
            {"start": 48,  "end": 56,  "speaker": "Voix 1", "text": "Oui, la version Explorer Suit, la deuxième génération du robot, compte 3 261 pièces au total. C'est un vrai puzzle géant. Il faut être super précis."},
            {"start": 56,  "end": 60,  "speaker": "Voix 2", "text": "Quel travail ! Et c'est fini après l'assemblage ?"},
            {"start": 60,  "end": 72,  "speaker": "Voix 1", "text": "Pas encore. Chaque pièce est testée : bruit, vibrations, endurance. Pour te donner un exemple, la boule du rolling globe peut rouler jusqu'à 5 000 km rien que pendant les essais."},
            {"start": 72,  "end": 75,  "speaker": "Voix 2", "text": "Il en fait du trajet ! Et après tous ces tests ?"},
            {"start": 75,  "end": 81,  "speaker": "Voix 1", "text": "On assemble le robot complet et on le teste encore pour vérifier qu'il bouge bien et qu'il est solide."},
            {"start": 81,  "end": 84,  "speaker": "Voix 2", "text": "C'est long ! Et ensuite, il bouge tout seul ?"},
            {"start": 84,  "end": 97,  "speaker": "Voix 1", "text": "Un peu de patience. Il faut l'aider à découvrir son corps : calibrer ses capteurs, ajuster ses moteurs, aligner les caméras. Petit à petit, il apprend à bouger, à voir et à se repérer. Un peu comme toi quand tu étais bébé."},
            {"start": 97,  "end": 100, "speaker": "Voix 2", "text": "Et bim ! Il est prêt à aider les humains."},
            {"start": 100, "end": 103, "speaker": "Voix 1", "text": "Exact. Cette fois, c'est la bonne : le Mirokaï est enfin prêt !"},
        ],
    },
    {
        "number": 11,
...
Voix 1 : Et cette fresque en garde la mémoire. Ouvre bien les yeux, elle est remplie de détails et de petits clins d'œil à cette incroyable création.""",
        "transcript_segments": [
            {"start": 0,  "end": 6,  "speaker": "Voix 1", "text": "Voilà les amis, on arrive à la fin de notre visite. Cette fresque raconte toute l'aventure de la création des Mirokaï."},
            {"start": 6,  "end": 12, "speaker": "Voix 2", "text": "Oui, tu te souviens, tout a commencé avec Jérôme, le créateur d'Enchanted Tools, accompagné d'Oumarou et de Robert."},
            {"start": 12, "end": 19, "speaker": "Voix 1", "text": "Ah oui, c'est vrai ! Et ils n'ont pas commencé par la technique, mais par le dessin des robots. C'est leur apparence qui allait guider tout le reste."},
            {"start": 19, "end": 27, "speaker": "Voix 2", "text": "Tu as découvert Miroki et Miroka et leur histoire fascinante. Puis, Spoon a donné vie à ces dessins en 3D : les visages bougent, les expressions s'animent."},
            {"start": 27, "end": 34, "speaker": "Voix 1", "text": "Et le plus incroyable, c'est de transformer ces personnages en de vrais robots, avec des combinaisons fidèles aux dessins."},
            {"start": 34, "end": 42, "speaker": "Voix 2", "text": "Tu as aussi pu voir les prototypes et les tests : mouvements, voix, capacité à saisir les objets, déplacements… chaque détail a été vérifié avec soin."},
            {"start": 42, "end": 48, "speaker": "Voix 1", "text": "Même les accessoires ont suivi le même parcours, souvent pensés grâce aux besoins des futurs utilisateurs."},
            {"start": 48, "end": 54, "speaker": "Voix 2", "text": "En résumé, chaque Mirokaï est le fruit d'une grande aventure humaine et technologique."},
            {"start": 54, "end": 61, "speaker": "Voix 1", "text": "Et cette fresque en garde la mémoire. Ouvre bien les yeux, elle est remplie de détails et de petits clins d'œil à cette incroyable création."},
        ],
    },
]
